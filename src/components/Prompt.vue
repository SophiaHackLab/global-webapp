...
<template>
    <div>
        ...
        >
            <div class="bg-black p-5 border border-white/50 gap-3 flex flex-col w-full md:w-fit">
                <div class="gap-3 flex flex-col">
                    ...
                    <p v-if="props.subtitle" class="text-white/80">{{ props.subtitle }}</p>

                    <div class="mt-3 w-full max-h-[calc(100vh-15rem)] overflow-y-auto">
                        <slot name="content" />
                    </div>
