...
<template>
    ...
    >
        ...
        >
            <div
                class="flex flex-row md:flex-col items-center md:mb-2 gap-2 md:gap-0"
            >
            ...
            >
                <span
                    class="bg-green-400 text-black text-xs px-2 py-0.5 uppercase"
                    >Aujourd'hui</span
                >
            </p>
            <p
            ...
            <p v-else-if="isEventPassed(agendaEvent.date)">
                <span
                    class="bg-white/80 text-black text-xs px-2 py-0.5 uppercase"
                    >Passé</span
                >
            </p>
            <p v-else>
                <span
                    class="bg-amber-400 text-black text-xs px-2 py-0.5 uppercase"
                    >Bientôt
                </span>
            </p>
        </div>
        <div class="w-full border border-white/50 p-4 flex flex-col gap-3">
            <div class="flex flex-col gap-1.5">
                ...
                <p
                    class="text-sm md:text-base font-normal text-white/70 line-clamp-2"
                >
                ...
                <div class="flex gap-5 flex-col md:flex-row w-full">
                    <div class="flex gap-2">
                        <IconsLock
                            ...
                            class="w-4 h-4 min-w-4 mt-0.5"
                        />
                        <IconsBeer v-else class="w-4 h-4 min-w-4 mt-0.5" />
                        <p
